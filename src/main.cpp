...
// Copyright (c) 2013-2014 Extremecoin Developers
...
uint256 hashGenesisBlock("0xc6f87e3d194e61bd61bb13d2d50ff712eb3ce180467b50806b10989fac4ed561");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Extremecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc6f87e3d194e61bd61bb13d2d50ff712eb3ce180467b50806b10989fac4ed561");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Its Extreme Time";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1376699608; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2332268;

        if (fTestNet)
        {
            block.nTime    = 1376736167;
            block.nNonce   = 2332268;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb4771b475d079c205112e507f167b6b5a9bf1cc56e774511d46be4c2eab47ba9"));
