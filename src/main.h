...
static const int64 MAX_MONEY = 5000000 * COIN; // 5 Million maximum number of coins, to take into account the 1 Coin block reward.
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 288 / 250; // 288 blocks found a day. Priority cutoff is 1 EXC day / 250 bytes.
    }
